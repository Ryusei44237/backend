...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/hinagata.css">
<link rel="stylesheet"
		...
		<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog"
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="modal-body">
							<form id="postform" action="/sotuken/PostServlet" method="POST"
			...
			<section class="header">
				<div class="header_items">
					...
					<div id="h_item2">
						<div id="form_group">
							<form action="/sotuken/SignUp" method="get">
								<button type="submit" class="clear-decoration">登録</button>
							</form>
							<form action="/sotuken/TestServlet" method="get">
								<button type="submit" class="clear-decoration">ログイン</button>
							</form>
							<form action="/sotuken/MyPageServlet" method="get">
					...
					<div id="h_item4">
						<div id="searchform">
							<form class="form-inline my-2 my-lg-0"
								style="width: 20vw; display: flex;" action="/sotuken/PostSearch"
								method="post">
			...
			<div class="container_body">
				...
				<sction class="main"> <!-- カルーセル -->
				<div id="carousel-area">
					<!-- カルーセルエリアを左、中央、右に三等分する -->
					<div id="carousel_left_side">leftside</div>
							...
							<div id="carouselExampleIndicators" class="carousel slide"
								...
								<div class="carousel-inner">
									<div class="carousel-item active">
										<iframe
											src="https://www.youtube-nocookie.com/embed/WV5w19J-cAA? loop=1&playlist=vdxoDyNAoH0&autoplay=1&mute=1&rel=0&modestbranding=1"
											frameborder="0" allowfullscreen></iframe>
									</div>
									<div class="carousel-item">
										<iframe
											src="https://www.youtube-nocookie.com/embed/coYw-eVU0Ks? loop=1&playlist=vdxoDyNAoH0&autoplay=1&mute=1&rel=0&modestbranding=1"
											frameborder="0" allowfullscreen></iframe>
									</div>
									<div class="carousel-item">
										<iframe
											src="https://www.youtube-nocookie.com/embed/WXoMJJCaQPU? loop=1&playlist=vdxoDyNAoH0&autoplay=1&mute=1&rel=0&modestbranding=1"
											frameborder="0" allowfullscreen></iframe>
									</div>
								</div>
					...
					<div id="carousel_right_side">rightside</div>
				</div>
				<!-- card -->
				<div id="card">
					<div class="card-deck">
				...
				<sction class="right_menu"> right_menu </sction>
			</div>
		</div>
		<section class="footer">rights.ryusei</section>
